...
import "../interfaces/IOptimisticForm.sol";
import "./decodeAssertionID.sol";
...
contract OxOptimisticFormEscalationManager is EscalationManagerInterface, Ownable {
    ...
    function _checkIfAssertionBlocked(bytes32 assertionId) internal view returns (bool) {
        OptimisticOracleV3Interface.Assertion memory assertion = optimisticOracleV3.getAssertion(
            assertionId
        );
     ...
     */
    function assertionResolvedCallback(bytes32 assertionId, bool assertedTruthfully) external onlyOptimisticOracleV3{}
     ...
     */
    function assertionDisputedCallback(bytes32 assertionId) external onlyOptimisticOracleV3{}
