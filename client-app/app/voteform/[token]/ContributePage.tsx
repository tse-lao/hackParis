...
const ContributePage: FC<ContributePageProps> = ({data}) => {
    ...
    const { data:simsoClaims, isLoading, isError, isSuccess:foundSismo, error:claimError } = useContractRead({
    ...
    const CurrentStepComponent = useMemo(() => {
      switch (activeStep) {
        case 0:
          return <ContributionAccess getProof={handleProof} nextStep={handleNextStep} claims={simsoClaims} />;
        case 1:
    ...
    return ( 
        ...
        <div className="flex flex-col justify-center items-center ">
          ...
          <span>
            {simsoClaims}
            {isError && claimError.message}
            {foundSismo && "succes found"}
          </span>
        <div>
        </div>
